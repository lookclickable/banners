...
lib.properties = {
	...
	color: "#333333",
	manifest: [
		{src:"images/acehearts.png?1504860169092", id:"acehearts"},
		{src:"images/acespade.png?1504860169092", id:"acespade"},
		{src:"images/aple.png?1504860169092", id:"aple"},
		{src:"images/buty.png?1504860169092", id:"buty"},
		{src:"images/logo.png?1504860169092", id:"logo"},
		{src:"images/mob.png?1504860169092", id:"mob"},
		{src:"images/seven.png?1504860169092", id:"seven"},
		{src:"images/sevenheart.png?1504860169092", id:"sevenheart"},
		{src:"images/sevenspade.png?1504860169092", id:"sevenspade"}
	]
};
...
(lib.Symbol15 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#634B2B").s().p("");
	this.shape.setTransform(201.8,15);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#634B2B").s().p("AgRAnQgGgDgEgDQgDgFgDgGQgCgHAAgIIAAguIAPAAIAAAqIABALQABAEADADQACADAEABQAEACAFAAQAFABAHgEQAGgEAEgFIAAg2IAOAAIAABOIgOAAIAAgMQgFAGgHADQgKAFgFAAQgHAAgFgCg");
	this.shape_1.setTransform(192.9,15.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#634B2B").s().p("AgHA9IgFgDQgDgEgBgEIgBgKIAAhmIAOAAIAABfQAAAJACADQABAFAFAAQAEgBAGgDIADALIgHAEQgGACgFAAQgEAAgDgCg");
	this.shape_2.setTransform(186.2,12.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#634B2B").s().p("AgmA+IAAh7IAggBQAIABANADQAJADAFAGQAFAFADAIQACAGAAAHQAAAJgDAGQgDAIgFADQgGAFgIAEQgNADgFAAIgTAAIAAAvgAgXguIAAAuIASAAQAFABAGgBQAFgBAEgDQAEgEACgEQACgEAAgHQAAgFgCgFQgBgEgEgEQgDgCgGgCQgGgCgFAAg");
	this.shape_3.setTransform(178.2,12.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#634B2B").s().p("AgXA+IArhtIg4AAIAAgOIBJAAIAAAJIgsByg");
	this.shape_4.setTransform(163.9,12.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#634B2B").s().p("");
	this.shape_5.setTransform(151,15);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#634B2B").s().p("AAWAoIAAgqIgBgLQgCgEgDgDQgCgDgFgBQgEgCgFAAQgFAAgGADQgGADgEAEIAAA4IgPAAIAAhOIAPAAIAAAJQAEgEAHgDQAHgDAGAAQAIAAAGABQAGADAEAEQAFAEACAGQACAIAAAJIAAAsg");
	this.shape_6.setTransform(141.4,14.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#634B2B").s().p("");
	this.shape_7.setTransform(131.4,15);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#634B2B").s().p("AAWA+IAAgsIgBgLQgBgEgEgDQgDgBgDgCQgFgBgFAAQgFAAgGADQgGABgEAEIAAA6IgPAAIAAh7IAPAAIAAA2QAFgFAGgDQAIgDAFAAQAIAAAGACQAGACAFAFQAEAEACAFQACAHABAJIAAAug");
	this.shape_8.setTransform(121.5,12.7);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#634B2B").s().p("AgmA+IAAh7IAggBQAIABANADQAJADAFAGQAFAFADAIQACAGAAAHQAAAJgDAGQgDAIgFADQgGAFgIAEQgNADgFAAIgTAAIAAAvgAgXguIAAAuIASAAQAFABAGgBQAFgBAEgDQAEgEACgEQACgEAAgHQAAgFgCgFQgBgEgEgEQgDgCgGgCQgGgCgFAAg");
	this.shape_9.setTransform(111.6,12.7);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#634B2B").s().p("AgFA7IAAhOIALAAIAABOgAgEgrQgEgCAAgFQAAgDAEgDQACgCACAAQADAAADACQACADAAADQAAAFgCACQgDADgDAAQgCAAgCgDg");
	this.shape_10.setTransform(103.4,13);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#634B2B").s().p("AgqA+IAAh7IAdAAIAAAnIALgBQAKAAAJADQAJADAGAFQAFAGADAGQADAIAAAKQAAAJgDAJQgEAIgHAGQgKAHgGACQgNAEgIAAgAgNADIAAAgIAIABIAGgBQAEgCACgCQADgCABgDQACgDAAgFQAAgEgCgDQgBgEgDgCQgFgDgHAAg");
	this.shape_11.setTransform(91.9,12.8);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#634B2B").s().p("AgMA+IAAhgIgmAAIAAgbIBlAAIAAAbIglAAIAABgg");
	this.shape_12.setTransform(80.5,12.7);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#634B2B").s().p("AAiA+IgLgaIgvAAIgKAaIgdAAIAzh7IAYAAIA1B7gAAMAJIgMghIgOAhIAaAAg");
	this.shape_13.setTransform(68.7,12.7);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#634B2B").s().p("AgrA+IAAh7IAmgBQAIABAPADQAGACAJAIQAGAFACAIQADAHAAAJQAAAHgDAJQgDAFgGAGQgHAGgHADQgKADgIAAIgOAAIAAAqgAgOgiIAAAcIANABQAEAAAFgDIAEgEQABgDAAgFIgBgHIgDgFQgEgDgHAAg");
	this.shape_14.setTransform(57,12.7);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#634B2B").s().p("AgiA+IAAh7IBGAAIAAAbIgpAAIAABgg");
	this.shape_15.setTransform(47,12.7);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#634B2B").s().p("AAaA+IAAhMIg2BMIgZAAIAAh7IAdAAIAABMIA1hMIAZAAIAAB7g");
	this.shape_16.setTransform(34.7,12.7);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#634B2B").s().p("Ag+A+IAAh7IAdAAIAAAnIALgBQAMAAAIADQAHADAGAFQAFAGADAGQADAIAAAKQAAAJgEAJQgDAIgHAGQgGAGgIADQgOAEgIAAgAghADIAAAgIAIABIAIgBQAEgCACgCQACgCABgDIABgIIgBgHIgEgFQgEgEgIAAgAAiA+IAAh7IAdAAIAAB7g");
	this.shape_17.setTransform(19.7,12.8);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#634B2B").s().p("");
...
(lib.Символ7 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(103.2,13.9,1,1,0,0,0,103.2,13.9);
...
(lib.Symbol16 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(127.6,37.4,1,1,0,0,0,103.2,13.9);

	this.instance_1 = new lib.buty();
	this.instance_1.setTransform(0,1.5);

	this.instance_2 = new lib.Символ8();
	this.instance_2.setTransform(128,36,1.053,1.053,0,0,0,128,34.5);
	this.instance_2.filters = [new cjs.ColorFilter(0.82, 0.82, 0.82, 1, 45.9, 45.9, 45.9, 0)];
	this.instance_2.cache(-2,-2,260,73);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance,p:{scaleX:1,scaleY:1,y:37.4}}]}).to({state:[{t:this.instance_2},{t:this.instance,p:{scaleX:1.053,scaleY:1.053,y:36.7}}]},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,1.5,256,69);
...
p.nominalBounds = new cjs.Rectangle(-6.8,-0.3,269.6,72.6);
...
p.nominalBounds = new cjs.Rectangle(10,1.5,256,69);
...
(lib.iphone7kz_240400 = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(79.5,37.8,1.147,1.147,0,0,0,45.6,10.6);
