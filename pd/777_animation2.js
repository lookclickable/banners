...
p.nominalBounds = new cjs.Rectangle(0,0,318,399);// helper functions:
...
// stage content:
(lib._777_animation2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Символ 1
	this.instance = new lib.Символ1();
	this.instance.parent = this;
	this.instance.setTransform(277.5,599.5,1,1,0,0,0,199.5,60.5);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(286,321.5,1,1,0,0,0,207,180.5);

	this.instance_2 = new lib.Символ2();
	this.instance_2.parent = this;
	this.instance_2.setTransform(1486.5,623,1,1,0,0,0,383.5,528);
	...
	this.shape.setTransform(552.1,393.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(175.9,309.3,1439.6,840.2);
// library properties:
lib.properties = {
	id: 'DFC94C9F93C84B52AE68F8D98BC2C55B',
	width: 1100,
	height: 780,
	fps: 24,
	color: "#333333",
	opacity: 0.00,
	manifest: [
		{src:"images/ace1.png?1503908221266", id:"ace1"},
		{src:"images/ace2.png?1503908221266", id:"ace2"},
		{src:"images/blink.png?1503908221266", id:"blink"},
		{src:"images/Button.png?1503908221266", id:"Button"},
		{src:"images/hearts.png?1503908221266", id:"hearts"},
		{src:"images/rombs.png?1503908221266", id:"rombs"},
		{src:"images/spades.png?1503908221266", id:"spades"},
		{src:"images/TextBlock.png?1503908221266", id:"TextBlock"},
		{src:"images/tshirt.png?1503908221266", id:"tshirt"}
	],
	preloads: []
};
...
an.compositions['DFC94C9F93C84B52AE68F8D98BC2C55B'] = {
