...
(lib.the36iph = function() {
	this.initialize(img.the36iph);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,269,47);


(lib.theone = function() {
	this.initialize(img.theone);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,276,238);


(lib.thetwo = function() {
	this.initialize(img.thetwo);
}).prototype = p = new cjs.Bitmap();
...
(lib.Symbol11 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.the36iph();
	this.instance.parent = this;
