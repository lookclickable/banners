...
lib.properties = {
	...
	color: "#000000",
	manifest: [
		{src:"images/back.jpg?1504786434534", id:"back"},
		{src:"images/body.png?1504786434534", id:"body"},
		{src:"images/car.png?1504786434534", id:"car"},
		{src:"images/cursy.png?1504786434534", id:"cursy"},
		{src:"images/fing.png?1504786434534", id:"fing"},
		{src:"images/fing2.png?1504786434534", id:"fing2"},
		{src:"images/foot.png?1504786434534", id:"foot"},
		{src:"images/foot2.png?1504786434534", id:"foot2"},
		{src:"images/hand.png?1504786434534", id:"hand"},
		{src:"images/hand2.png?1504786434534", id:"hand2"},
		{src:"images/handcurs.png?1504786434534", id:"handcurs"},
		{src:"images/head.png?1504786434534", id:"head"},
		{src:"images/leg1.png?1504786434534", id:"leg1"},
		{src:"images/leg2.png?1504786434534", id:"leg2"},
		{src:"images/round.png?1504786434534", id:"round"},
		{src:"images/shold1.png?1504786434534", id:"shold1"},
		{src:"images/shold2.png?1504786434534", id:"shold2"},
		{src:"images/taz.png?1504786434534", id:"taz"}
	]
};
...
(lib.getcar2_600300 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		var carbt = document.getElementById('btn_left');
		var girlbt = document.getElementById('btn_right');
		...
		carbt.addEventListener("mouseover", fl_Clickover3);
		function fl_Clickover3()
		{
			_this.pric.gotoAndStop(2);
			_this.tek.gotoAndPlay(2);
			_this.car.gotoAndPlay(2);
		}
		
		carbt.addEventListener("mouseout", fl_Clickout3);
		function fl_Clickout3()
		{
			_this.pric.gotoAndStop(2);
			_this.tek.gotoAndPlay(16);
			_this.car.gotoAndPlay(21);
		}
		
		
		
		girlbt.addEventListener("mouseover", fl_Clickover2);
		function fl_Clickover2()
		{
			_this.pric.gotoAndStop(1);
			_this.tek.gotoAndPlay(31);
			_this.car.gotoAndPlay(36);
		}
		
		girlbt.addEventListener("mouseout", fl_Clickout2);
		function fl_Clickout2()
		{
			_this.pric.gotoAndStop(1);
			_this.tek.gotoAndPlay(46);
			_this.car.gotoAndPlay(56);
		}
		
		main.addEventListener("mouseover", fl_Clickover1);
		function fl_Clickover1()
		{
			_this.osmotr.gotoAndPlay(1);
			_this.pric.alpha=1;
		    _this.finger.alpha=0;
			
			main.style.cursor = "none";
			
		}
		
		main.addEventListener("mouseout", fl_Clickout1);
		function fl_Clickout1()
		{
			_this.osmotr.gotoAndPlay(16);
			_this.pric.alpha=0;
			_this.finger.alpha=1;
		...
		main.addEventListener("mousemove", function(){
			_this.pric.x = stage.mouseX/window.devicePixelRatio;
			_this.pric.y = stage.mouseY/window.devicePixelRatio;
		});
