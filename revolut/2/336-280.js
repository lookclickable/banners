...
(lib.Symbol45 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FF6666").s().p("AqiDNQkYhVAAh4QAAh3EYhVQEXhVGLAAQGLAAEYBVQEYBVAAB3QAAB4kYBVQkYBVmLAAQmLAAkXhVg");
	this.shape.setTransform(95.5,29);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol45, new cjs.Rectangle(0,0,191,58), null);
...
(lib.Symbol41 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgPBLIAAggIAfAAIAAAggAgOAcIgEhmIAlAAIgEBmg");
	this.shape.setTransform(103.2,12);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAVBLIgShLIgDgSIAAAAIgDASIgTBLIgpAAIgkiVIAmAAIATBcIACAPIAAABIAAAAIADgQIAXhcIAdAAIAWBcIADAPIAAABIAAgBIACgPIAUhcIAmAAIgmCVg");
	this.shape_1.setTransform(89.7,12);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(70.8,12);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAaBLIgohGIgLgVIgCgEIAAAAIABAZIAABGIgkAAIAAiVIAlAAIAoBGIALAUIACAFIAAAAIgBgZIAAhGIAkAAIAACVg");
	this.shape_3.setTransform(54.3,12);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgSBLIAAg9IgxhYIApAAIARAkIAJAVIAAAAIAJgVIARgkIAqAAIgyBYIAAA9g");
	this.shape_4.setTransform(34.6,12);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AAgBLIgJggIguAAIgJAgIglAAIAziVIAlAAIAzCVgAAPAOIgJgcIgGgaIAAAAIgFAaIgJAcIAdAAg");
	this.shape_5.setTransform(21,12);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgwBLIAAiVIAkAAIAAB1IA9AAIAAAgg");
	this.shape_6.setTransform(9,12);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("Ag2BLIAAiVIA9AAQAVAAAOAPQAHAGADAKQAEAJgBAMQABALgEAJQgDAJgHAHQgOAOgVAAIgZAAIAAAvgAgSgCIASAAQAEAAAEgBIAGgFQAEgFAAgJQAAgKgEgFQgGgGgIAAIgSAAg");
	this.shape_7.setTransform(-3.5,12);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-12.7,1.2,121.2,25);
...
(lib.Symbol37 = function(mode,startPosition,loop) {
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(81.1,24.1,0.754,0.754,0,0,0,95.5,29.1);
	this.instance_1.filters = [new cjs.BlurFilter(42, 42, 1)];
	this.instance_1.cache(-2,-2,195,62);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol37, new cjs.Rectangle(-12,-18.8,190,89), null);
...
(lib.Symbol46 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(97.7,144.9,0.852,0.852,0,5.5,7.6,102.5,160.9);
	this.instance.alpha = 0.66;
	this.instance.compositeOperation = "lighter";

	this.instance_1 = new lib.Symbol2();
	this.instance_1.parent = this;
	this.instance_1.setTransform(97.7,144.9,0.852,0.852,0,5.5,7.6,102.5,160.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol46, new cjs.Rectangle(16,8,174,277.6), null);
...
(lib._336280 = function(mode,startPosition,loop) {
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(262.8,148.7,1,1,0,0,0,98.2,143.2);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(243.1,144.1,1,1,0,0,0,203.1,139.1);
	...
	this.instance_4.parent = this;
	this.instance_4.setTransform(219.6,107.4,0.917,0.933,0,0,0,383.5,177.8);
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/bodydos.png", id:"bodydos"},
		{src:"images/finger.png", id:"finger"},
		{src:"images/head.png", id:"head"},
		{src:"images/hear.png", id:"hear"},
		{src:"images/hear2.png", id:"hear2"},
		{src:"images/Layer17.png", id:"Layer17"},
		{src:"images/leg.png", id:"leg"},
		{src:"images/legs.png", id:"legs"},
		{src:"images/logo.png", id:"logo"},
		{src:"images/ship.png", id:"ship"},
		{src:"images/shold.png", id:"shold"},
		{src:"images/shold2.png", id:"shold2"},
		{src:"images/skirt.png", id:"skirt"},
		{src:"images/skirt2.png", id:"skirt2"},
		{src:"images/sword.png", id:"sword"},
		{src:"images/turtle.png", id:"turtle"},
		{src:"images/wing1.png", id:"wing1"},
		{src:"images/wing2.png", id:"wing2"},
		{src:"images/wing3.png", id:"wing3"}
	],
	preloads: []
};
