...
p.nominalBounds = new cjs.Rectangle(0,0,221,150);
...
p.nominalBounds = new cjs.Rectangle(0,0,177,119);// helper functions:
...
(lib.Symbol4 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(0,0,1.707,1.707);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol4, new cjs.Rectangle(0,0,302.1,203.1), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(0,0,360.2,204.8), null);
...
}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(0,0,377.2,256), null);
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(359.1,118.5,1,1,0,0,0,151.1,101.5);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(69).to({_off:false},0).to({x:249.1,alpha:1},10,cjs.Ease.get(1)).wait(30).to({x:141.1,alpha:0},10,cjs.Ease.get(1)).wait(1));

	// shield.png
	this.instance_1 = new lib.Symbol3();
	this.instance_1.parent = this;
	this.instance_1.setTransform(360.1,119.4,1,1,0,0,0,180.1,102.4);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(29).to({_off:false},0).to({x:250.1,alpha:1},10,cjs.Ease.get(1)).wait(30).to({x:140.1,alpha:0},10,cjs.Ease.get(1)).to({_off:true},1).wait(40));

	// bars.png
	this.instance_2 = new lib.Symbol2();
	this.instance_2.parent = this;
	this.instance_2.setTransform(250.6,145,1,1,0,0,0,188.6,128);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(29).to({x:137.6,alpha:0},10,cjs.Ease.get(1)).wait(70).to({x:357.6},0).to({x:250.6,alpha:1},10,cjs.Ease.get(1)).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(62,17,377.2,256);
...
(lib.index = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		window._setCanvasSize = function() {
			...
			_this.ico.x = ((s.iw > s.ih) ? s.iw * 0.24 : s.iw / 2);
			_this.ico.y = ((s.iw > s.ih) ? s.ih * 0.55 : s.ih * 0.35);
			
			_this.spons.x = ((s.iw > s.ih) ? s.iw * 0.73 : s.iw / 2);
			_this.spons.y = ((s.iw > s.ih) ? s.ih * 0.15 : s.ih * 0.21);
			
			_this.players.x = ((s.iw > s.ih) ? s.iw * 0.73 : s.iw / 2);
			_this.players.y = ((s.iw > s.ih) ? s.ih * 0.8 : s.ih * 0.8);
			...
			function setScale(scale) {
				...
				_this.players.scaleX = _this.players.scaleY = scale * 0.8;
				_this.btn.scaleX = _this.btn.scaleY = scale * 0.8;
			}
