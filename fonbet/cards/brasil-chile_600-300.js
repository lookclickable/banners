...
(lib.Symbol39 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgjA1QgIgDgFgHQgFgGgBgIQgCgJACgMIAKg3QABgEACgDQACgBAFAAIAXAAQAEAAACABQABADgBAEIgKA5QgBAGADACQACADAGAAIAIgBIACgCIAMhBQAAgEACgDQADgBAEAAIAXAAQAFAAABABQACADgBAEIgPBTQgBAFgCACQgDAEgFACQgLADgLACQgKACgNAAQgMAAgIgDg");
	this.shape.setTransform(17.1,15.3);
	...
	this.shape_1.setTransform(4.5,15.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgjA1QgIgDgFgHQgFgGgBgIQgCgJACgMIAKg3QABgEACgDQACgBAFAAIAXAAQAEAAACABQABADgBAEIgKA5QgBAGADACQACADAGAAIAIgBIACgCIAMhBQAAgEACgDQADgBAEAAIAXAAQAFAAABABQACADgBAEIgPBTQgBAFgCACQgDAEgFACQgLADgLACQgKACgNAAQgMAAgIgDg");
	this.shape_2.setTransform(-6.4,15.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAHBLQgFAAgCgCQgBgCABgFIAHgpIgVABQgTgBgHgDQgFgCgEgCIgHgHIgFgJIgCgKQgBgHACgTIAGgfQAAgFADgBQACgDAFAAIAYAAQAFAAABADQACABgBAFIgGAiIAAAJQAAAEADACQACACAEABIALABQAIAAAHgCIAJgzQABgFACgBQACgDAFAAIAYAAQAFAAACADQABABgBAFIgXCDQgBAFgCACQgCACgFAAg");
	this.shape_3.setTransform(-18.3,13.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol39, new cjs.Rectangle(-28.6,2.6,53.1,25), null);
...
(lib.Symbol29 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AALA2QgEABgCgCQgBgCABgFIAEgYIgJAAIgOAYQgDAGgEABQgDACgHgBIgUAAQgHAAgBgCQgBgDAEgFIAWgeQgHgFgCgIQgCgIABgKQACgJAEgHQAEgHAGgEQAGgFAHgDQAIgCAJABIAzAAQAFAAABABQACACgBAFIgQBbQgBAFgCACQgCACgFgBgAgEgQQgBAFACACQABABADAAIANAAIADgQIgNAAQgHABgBAHg");
	this.shape.setTransform(89.8,10);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgjA1QgIgDgFgGQgFgGgBgJQgCgJACgLIAKg4QABgEACgCQACgCAFAAIAXAAQAEAAACACQABACgBAEIgKA5QgBAFADADQACADAGAAIAIgBIACgCIAMhBQAAgEACgCQADgCAEAAIAXAAQAFAAABACQACACgBAEIgPBTQgBAFgCADQgDADgFABQgLAEgLACQgKACgNAAQgMAAgIgDg");
	this.shape_1.setTransform(79.1,10.1);
	...
	this.shape_2.setTransform(66.6,10.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgjA1QgIgDgFgGQgFgGgBgJQgCgJACgLIAKg4QABgEACgCQACgCAFAAIAXAAQAEAAACACQABACgBAEIgKA5QgBAFADADQACADAGAAIAIgBIACgCIAMhBQAAgEACgCQADgCAEAAIAXAAQAFAAABACQACACgBAEIgPBTQgBAFgCADQgDADgFABQgLAEgLACQgKACgNAAQgMAAgIgDg");
	this.shape_3.setTransform(55.6,10.1);
	...
	this.shape_4.setTransform(43.7,9.9);
	...
	this.shape_6.setTransform(20.7,12.1);
	...
	this.shape_7.setTransform(9,7.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol29, new cjs.Rectangle(0,-2.6,98,25), null);
...
(lib.Symbol7 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("EgjTAJjIAAzFMBGnAAAIAATFg");
	this.shape.setTransform(226,61.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol7, new cjs.Rectangle(0,0,452,122.2), null);
...
(lib.Symbol34 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(76.8,74.5,1,1,0,0,0,65.5,7.8);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(15).to({_off:false},0).to({y:56.3,alpha:1},4,cjs.Ease.get(1)).wait(1));

	// Symbol 3
	this.instance_1 = new lib.Symbol3();
	this.instance_1.parent = this;
	this.instance_1.setTransform(76.9,117.9,0.505,0.505,0,0,0,134.1,41.1);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:133.9,scaleX:0.69,scaleY:0.69,x:76.8,y:119.9,alpha:1},9,cjs.Ease.backOut).to({regX:134,regY:41,scaleX:0.57,scaleY:0.57,y:23.5},10,cjs.Ease.quadInOut).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(9.2,97.2,135.2,41.3);
...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(79).to({regX:47.6,scaleX:0.02,x:46.6,alpha:0.52},5,cjs.Ease.quadInOut).to({regX:46.5,scaleX:1,x:46.5,alpha:1},5,cjs.Ease.quadInOut).wait(11));
...
(lib.Symbol4 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(89).to({scaleX:0.08,x:75.6,alpha:0.52},5,cjs.Ease.quadInOut).to({scaleX:1,x:75.5,alpha:1},5,cjs.Ease.quadInOut).wait(1));
...
(lib.Symbol35 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(120,116,1,1,0,0,0,120,28.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(49).to({y:110.1},0).to({y:28.2},20,cjs.Ease.backOut).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,87.8,239.9,59.4);
...
(lib.Symbol27 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(130.4,262.7,1,1,0,0,0,49,12.5);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(38).to({_off:false},0).to({y:249.7,alpha:1},11,cjs.Ease.get(1)).wait(1));

	// Layer 1
	this.instance_1 = new lib.Symbol8();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-28.9,109.6,0.601,1,15,0,0,96.9,109.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(21).to({y:109.5},0).to({regX:96.8,scaleX:1,rotation:0,x:124.8},28,cjs.Ease.get(1)).wait(1));
...
(lib.Symbol37 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(297.4,102.9,1,1,0,0,0,41.1,12.5);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(49).to({_off:false},0).to({x:284.4,alpha:1},10,cjs.Ease.get(0.96)).wait(1));

	// Symbol 40
	this.instance_1 = new lib.Symbol40();
	this.instance_1.parent = this;
	this.instance_1.setTransform(170,102.9,1,1,0,0,0,56.5,12.5);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(49).to({_off:false},0).to({x:183,alpha:1},10,cjs.Ease.get(0.96)).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(45).to({y:57.4,alpha:0},0).to({y:50.9,alpha:1},10,cjs.Ease.quadInOut).wait(5));
...
p.nominalBounds = new cjs.Rectangle(0,304.8,452,122.1);
...
(lib.Symbol33 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(130.5,260.1,1,1,0,0,0,26.6,12.5);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(39).to({_off:false},0).to({y:247.1,alpha:1},10,cjs.Ease.get(1)).wait(1));

	// Layer 1
	this.instance_1 = new lib.Symbol16();
	this.instance_1.parent = this;
	this.instance_1.setTransform(306.4,102.1,0.538,1,-10.5,0,0,130.5,103.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(25).to({regX:130.4,regY:103.7,scaleX:1,rotation:0,x:130.4,y:116.7},24,cjs.Ease.get(1)).wait(1));
...
// stage content:
(lib.brasilchile_600300 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(530.4,147.9,1,1,0,0,0,130.4,130.7);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(93,149.1,1,1,0,0,0,125,130.4);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(302.6,158.9,1,1,0,0,0,226,65);
	...
	this.instance_5.parent = this;
	this.instance_5.setTransform(258,160.5,1,1,0,0,0,400,173.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(127.4,137,964.3,533.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1507105621138", id:"back"},
		{src:"images/CArd_left.png?1507105621138", id:"CArd_left"},
		{src:"images/CArd_right.png?1507105621138", id:"CArd_right"},
		{src:"images/Logo1.png?1507105621138", id:"Logo1"},
		{src:"images/Logo2.png?1507105621138", id:"Logo2"},
		{src:"images/logored.png?1507105621138", id:"logored"},
		{src:"images/shad.png?1507105621138", id:"shad"}
	],
	preloads: []
};
