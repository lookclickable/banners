...
(lib.Symbol22 = function(mode,startPosition,loop) {
	...
	this.instance.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(27, 21, 39, 0))];
...
(lib.Symbol21 = function(mode,startPosition,loop) {
	...
	this.instance.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(18, -8, 59, 0))];
...
(lib.Symbol20 = function(mode,startPosition,loop) {
	...
	this.instance.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(5, 0, 65, 0))];
...
(lib.Symbol19 = function(mode,startPosition,loop) {
	...
	this.instance.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(23, 44, 59, 0))];
...
(lib.Symbol15 = function(mode,startPosition,loop) {
	...
	this.instance.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(15, 20, 59, 0))];
...
(lib.Symbol14 = function(mode,startPosition,loop) {
	...
	this.instance.filters = [new cjs.ColorMatrixFilter(new cjs.ColorMatrix(15, 7, 59, 0))];
...
(lib.Symbol11 = function(mode,startPosition,loop) {
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(167.7,125.6,0.675,0.47,0,0,0,133.2,128.8);
	...
	this.instance_3.parent = this;
	this.instance_3.setTransform(148.8,122.4,1,1,0,0,0,62,42);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	this.instance.filters = [new cjs.ColorFilter(0.2, 0.2, 0.2, 1, 0, 33.6, 60, 0), new cjs.ColorMatrixFilter(new cjs.ColorMatrix(-35, -17, -26, 0))];
...
(lib.armored300250 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(84.4,30.6,0.698,0.698,0,0,0,100,28.8);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(221,222.3,1.475,1.475,0,0,0,71.2,18.6);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back.jpg?1510909863029", id:"back"},
		{src:"images/block1.png?1510909863029", id:"block1"},
		{src:"images/blocks2.png?1510909863029", id:"blocks2"},
		{src:"images/bodybro.png?1510909863029", id:"bodybro"},
		{src:"images/button.png?1510909863029", id:"button"},
		{src:"images/dulendbro.png?1510909863029", id:"dulendbro"},
		{src:"images/dullobro.png?1510909863029", id:"dullobro"},
		{src:"images/fireloop1_0.png?1510909863029", id:"fireloop1_0"},
		{src:"images/fireloop1_1.png?1510909863029", id:"fireloop1_1"},
		{src:"images/fireloop1_2.png?1510909863029", id:"fireloop1_2"},
		{src:"images/fireloop1_3.png?1510909863029", id:"fireloop1_3"},
		{src:"images/fireloop1_4.png?1510909863029", id:"fireloop1_4"},
		{src:"images/fireloop1_5.png?1510909863029", id:"fireloop1_5"},
		{src:"images/headbro.png?1510909863029", id:"headbro"},
		{src:"images/heads.png?1510909863029", id:"heads"},
		{src:"images/locator.png?1510909863029", id:"locator"},
		{src:"images/logorealaction.png?1510909863029", id:"logorealaction"},
		{src:"images/pooop.png?1510909863029", id:"pooop"},
		{src:"images/stone.png?1510909863029", id:"stone"},
		{src:"images/wheelbro.png?1510909863029", id:"wheelbro"},
		{src:"images/wheels.png?1510909863029", id:"wheels"},
		{src:"images/winas.png?1510909863029", id:"winas"}
	],
	preloads: []
};
